...
export const mokeUp = [
  {
    חינם: {
      valueFeatures: {
        משתמשים: "ללא הגבלה",
        "הזמנות יוצאות": "ללא הגבלה",
        "הזמנות נכנסות": "עד 5",
        "מוצרים בקטלוג": "עד 200",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "20 שקלים לכל 100 מיילים",
        "אופציה לדומיין פרטי": "ללא",
      },
      features: [
        "קטלוג און ליין",
        " ניהול משתמשים",
  ...
  },
  {
    "תשלום פר פעולה": {
      valueFeatures: {
        ...
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "עשרה שקלים לכל 100 מיילים",
        "אופציה לדומיין פרטי": '100 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
        " ניהול משתמשים",
  ...
  },
  {
    " ארגז ": {
      valueFeatures: {
        משתמשים: "ללא הגבלה",
        "הזמנות יוצאות": "ללא הגבלה",
        "הזמנות נכנסות": "ללא הגבלה",
        "מוצרים בקטלוג": "עד 500",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "עשרה שקלים לכל 100 מיילים",
        "אופציה לדומיין פרטי": '70 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
        " ניהול משתמשים",
  ...
  },
  {
    " מכולה": {
      valueFeatures: {
        ...
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "חמישה שקלים לכל 100 מיילים",
        "אופציה לדומיין פרטי": '50 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
        " ניהול משתמשים",
  ...
  },
  {
    " אוניה": {
      valueFeatures: {
        ...
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "שלושה שקלים לכל 100 מיילים",
        "אופציה לדומיין פרטי": '50 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
