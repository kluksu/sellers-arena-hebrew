...
export const mokeUp = [
  {
    חינם: {
      valueFeatures: {
        משתמשים: "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי הספק)": "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי קונים)": "עד 5",
        "מוצרים בקטלוג": "עד 200",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "20 שקלים לכל 1000 מיילים",
        "אתר וויט לייבל (כתובת נפרדת)": "ללא",
      },
      features: [
        "קטלוג און ליין",
        " ניהול משתמשים",
        "מערכת עדכונים אוטומטית לעוקבים",
        "ניהול הזמנות יוצאות",
        "ניהול הזמנות נכנסות",
      ],
    },
  ...
  },
  {
    "תשלום פר פעולה": {
      valueFeatures: {
        משתמשים: "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי הספק)": "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי קונים)":
          " 5 ראשונות חינם ולאחר מכן ללא הגבלה בעלות חמישה שקלים להזמנה",
        "מוצרים בקטלוג":
          "עד 200 ללא תוספת תשלום , כל 500 נוספים או חלק מהם עשרה שקלים",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "עשרה שקלים לכל 1000 מיילים",
        "אתר וויט לייבל (כתובת נפרדת)": '50 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
        " ניהול משתמשים",
  ...
  },
  {
    " basic ": {
      valueFeatures: {
        משתמשים: "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי הספק)": "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי קונים)": "ללא הגבלה",
        "מוצרים בקטלוג": "עד 500",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "עשרה שקלים לכל 1000 מיילים",
        "אתר וויט לייבל (כתובת נפרדת)": '50 ש"ח לחודש',
      },
      features: [
  ...
  },
  {
    " advanced ": {
      valueFeatures: {
        ...
        "הזמנות נכנסות (נעשות על ידי הספק)": "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי קונים)": "ללא הגבלה",
        "מוצרים בקטלוג": "עד 1500",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "חמישה שקלים לכל 1000 מיילים",
        "אתר וויט לייבל (כתובת נפרדת)": '50 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
  ...
  },
  {
    " pro ": {
      valueFeatures: {
        ...
        "הזמנות נכנסות (נעשות על ידי הספק)": "ללא הגבלה",
        "הזמנות נכנסות (נעשות על ידי קונים)": "ללא הגבלה",
        "מוצרים בקטלוג": "עד 4000",
        " מייל עדכון יומי לעוקבים (אופציונאלי)": "שלושה שקלים לכל 1000 מיילים",
        "אתר וויט לייבל (כתובת נפרדת)": '50 ש"ח לחודש',
      },
      features: [
        "קטלוג און ליין",
  ...
  },
  {
    ...
    price: "מרגישים שאין פה חבילה שמכסה את כל מה שאתם צריכים? דברו איתנו!",
  },
];
