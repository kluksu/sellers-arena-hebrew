        ...
        <div className="featuresPageUpper">
          ...
          <Row>
            <Squre
              ...
              text="המוצר שפיתחנו כאן כדי לשנות את דרכי העבודה הישנות הנהוגות בעולם הסיטונאות, המערכת  באה לתת מענה לצרכים של בעלי העסקים הקמעונאים מצד אחד ומהצד השני ליעל את תהליכי ההזמנה והשיווק של הספקים, ככה שיווצר מצב של win-win"
              background="white"
              color="black"
            ></Squre>{" "}
          </Row>
